...
# =====================================================================
# 하락장에서는 무엇을 사느냐보다 어떻게 파느냐가 크다
# =====================================================================
#
# 하락·횡보 3구간(2021-07~2022-12, 2021-01~2022-12, 2024-07~2025-03)에서
# 매수 6종 × 청산 8종을 자리 10개 계좌로 굴리고, 뽑기 운을 없애려고 무작위
# 선택 15회의 분포로 쟀다 (45회 시행).
#
#   매수 신호별 3구간 평균 (청산 전체 평균)   −10.18% ~ −14.43%   차이  1.0%p
#   청산 규칙별 3구간 평균 (매수 전체 평균)    −6.31% ~ −17.85%   차이 11.5%p
#
#   익절 10%            −6.31%   현금 이김 62/270   승률 59%   ← 1위
#   %R > -5             −7.66%              57/270
#   익절 20%            −8.46%              51/270
#   20일 보유(청산없음)  −14.41%              23/270
#   손절 8%            −17.21%              13/270   승률 19%
#   익절 10% + 손절 8%  −17.85%               3/270   ← 꼴찌
#
# 1위(익절 10%)에 손절 8% 하나를 붙이면 꼴찌가 된다. 그리고 45회 시행에서
# 현금(파킹 연 2.5%)을 이긴 최대가 18회(40%) 였다 — 하락장이라고 확신하면
# 매매하지 않는 쪽이 기대값이 높다.
